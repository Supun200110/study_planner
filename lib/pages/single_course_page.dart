...
final Course course;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     appBar: AppBar(),
     body: Padding(padding: EdgeInsets.symmetric(horizontal: 10.0),
     child: Column(
                  ...
                  child: TextButton(
                    ...
                    child:  Column(
                      ...
                      children: [
                        ...
                        // description of the button
                        Text(
                          'Add notes for this course to help you remember important information and topics.And you can also add images and links.',
                          style: TextStyle(
                            color: Colors.black54,
                            fontSize: 12,
                          ),
